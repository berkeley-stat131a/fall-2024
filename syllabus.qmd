...
<!-- - [About Statistics 131a](#about-statistics-131a) -->
...
Lab 102: Tuesday and Thursday, 4-5p \@ [Evans 344](https://www.berkeley.edu/map/evans-hall/)
...
Concurrent enrollment students wishing to register for the class should fill out this [Google Form](https://docs.google.com/forms/d/e/1FAIpQLSfbYciXBFrZvO1WbtsIOTCOiWmV2EvC3RqN0dW9_3NHzE2QWQ/viewform?usp=sf_link) to give me information about their previous coursework so I can assess whether they have satisfied the pre-requisites.

Students who wish to audit the course can also fill out the top portion of this form to get their email added to bcourses as a guest. 
Only name and email is needed for auditors.

## Course platforms 🖥️

[bcourses](https://bcourses.berkeley.edu) will only be used for secure course material, like exam solutions, grades, and office hour Zoom links.

All other course materials will be posted on [the public course website](https://stat131a.berkeley.edu).

Assignments should be submitted via [Gradescope](https://www.gradescope.com).

All course communication will take place via [Ed](https://edstem.org).

The only acceptable large-language model is [PingPong](https://pingpong.hks.harvard.edu/login). 
Enrolled students will receive an invitation to PingPong via email shortly after the semester begins. **Unless otherwise indicated, all other LLMs (e.g., ChatGPT) are prohibited and considered cheating in this course.**

## Office hours (OH) 🗓️

Office hours times are TBD. 

- Times will be posted shortly after the semester begins.
- Please note that there are no regular OH during the first week of class.
- We may add or reschedule OH if needed. Please create a private Ed post if you have conflicts with all of the scheduled OH. 
- For security reasons, Zoom links for OH are posted on [bcourses](https://bcourses.berkeley.edu/).
...
- Lecture recordings are posted on [bcourses](https://bcourses.berkeley.edu/).
...
- Difficulty with paying attention in live meetings is a common hurdle for new grads. Most of life cannot be watched via recording! 
...
- This form can be completed in advance! 
...
- The students with the most unique neighbor discussions will receive the full two percentage points of extra credit.
- Everyone else will receive, at the minimum, a fraction of extra credit proportional to their number of unique neighbors.
- This policy will only take effect if at least one student has spoken to 20 unique neighbors over the course of the semester.
...
- All homework assignments will be submitted via [Gradescope](https://www.gradescope.com) and are due by 11:59 pm of the due date.
...
Labs will review conceptual material and work through lab coding assignments.
...
- Lab are intended to be finished or mostly finished during section.
- HW assignments may build on the exercises covered in lab.

Lab assignments are generally due on Mondays at 11:59 pm and should be submitted via [Gradescope](https://www.gradescope.com).

- Labs are graded on completion, not correctness.

**However, there is a self-paced [Lab 0](https://epurdom.github.io/Stat131A/RSupport/Lab00.html) for you to work through independently.**
...
The final project will be due on the last day of of reading week, **Friday December 13**.
...
Most of the course material is covered by the online textbook developed specifically for 131A.
...
There are videos on many of the topics we will cover in class.
...
- [R for Data Science](http://r4ds.had.co.nz), by Garrett Grolemund and Hadley Wickham. This is a free online book that covers the tidyverse.
...
- You are responsible for understanding every line of code that you submit in 131A. Exams may ask you to explain specific lines of code used in lab and HW solutions. 
- Of course, LLMs cannot be used on exams. 

It is often easy to spot default LLM text output. 
For example, if you copy and paste answers directly from PingPong, be warned that your grader may interpret your answer as lacking in effort and **you may lose points on the assignment.**
...
We use the [Ed platform](https://edstem.org) to manage course questions and discussion, and to make announcements.
...
Week 13.
Decision trees.
Random Forests.                                   [8](https://epurdom.github.io/Stat131A/book/regression-and-classification-trees.html) 
...
Intro to causal inference, if time permits.
...
**If you already have a Letter of Accommodation, please open a private [Ed post](https://edstem.org) ASAP and attach your LoA.** - We can accommodate you more easily if you provide this information early in the semester.
...
It is our intent that students from all backgrounds and perspectives be well served by this course, that students' learning needs be addressed both in and out of class, and that the diversity that students bring to this class be viewed as a resource, strength, and benefit. 
We aim to present materials and conduct activities in ways that are respectful of this diversity. 
Your suggestions are encouraged and appreciated. 
Please let us know if you have ideas to improve the effectiveness of the course for you personally or for other students or student groups.